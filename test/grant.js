    ...
    it('should return an oauth compatible response', function (done) {
      ...
      request(app.listen())
        ...
        .end(function (err, ctx) {
          ...
          var body = JSON.parse(ctx.text);
          body.should.have.keys(['access_token', 'token_type',
            'expires_in']);
          body.access_token.should.a.String;
          body.access_token.should.have.length(40);
    ...
    it('should return an oauth compatible response with refresh_token', function (done) {
      ...
      request(app.listen())
        ...
        .end(function (err, ctx) {
          ...
          var body = JSON.parse(ctx.text);
          body.should.have.keys(['access_token', 'token_type', 'expires_in',
            'refresh_token']);
          body.access_token.should.a.String;
          body.access_token.should.have.length(40);
          body.refresh_token.should.a.String;
          body.refresh_token.should.have.length(40);
          body.token_type.should.equal('bearer');
          body.expires_in.should.equal(3600);
    ...
    it('should exclude expires_in if accessTokenLifetime = null', function (done) {
      ...
      request(app.listen())
        ...
        .end(function (err, ctx) {
          ...
          var body = JSON.parse(ctx.text);
          body.should.have.keys(['access_token', 'refresh_token', 'token_type']);
          body.access_token.should.a.String;
          body.access_token.should.have.length(40);
          body.refresh_token.should.a.String;
          body.refresh_token.should.have.length(40);
